...
// public functions
	...
	void advanceCheckpoint(int raceID, int eventTruckNum, racesCompetitor@ competitor)
	{
		...
		{
			if( (time-this.raceList[raceID].bestTimeTillPoint[competitor.lastCheckpoint]) > 0 )
				timeDiff = " (+"+ (time-this.raceList[raceID].bestTimeTillPoint[competitor.lastCheckpoint]) +")";
			else if( (time-this.raceList[raceID].bestTimeTillPoint[competitor.lastCheckpoint]) < 0 )
			{
				timeDiff = " ("+ (time-this.raceList[raceID].bestTimeTillPoint[competitor.lastCheckpoint]) +")";
