...
public:
    ...
    */
    ...
    int envokeCallback(int functionId, eventsource_t *source, node_t *node = 0, int type = 0, int truckNum = -1); //cosmic vole added truckNum to ease detection of AI trucks at checkpoints etc.
