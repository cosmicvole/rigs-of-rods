...
void RigSpawner::InitializeRig()
{
	...
	m_rig->damaged_node_pos = new Ogre::Vector3[req.num_nodes];
	m_rig->target_node_pos = new Ogre::Vector3[req.num_nodes];
	...
	m_rig->vehicle_ai->SetSimController(m_sim_controller);
